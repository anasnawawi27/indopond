...
class FormBuilder
{
    ...
    private $config       = array(/* Config array - can be overrided by passing in array in ini() */
        ...
        'default_control_label_class'    => 'col-form-label ',
    ...
    function adv_set_value($field = '', $default = '')
    {
        ...
        // return htmlspecialchars($OBJ->set_value($field, $default), ENT_QUOTES, 'UTF-8');
    }
            ...
            switch ($this->func) {
                ...
                case 'form_submit':
                    ...
                    if ($back_url) {
                        ...
                        $input_html_string = '<a href="' . $back_url . '" class="btn btn-secondary" style="color:black">' . $back_label . '</a>';
                    }
                    // $input_html_string .= '<button type="submit" class="'.$class.' ml-3">'.$label.'</button>';
                    $input_html_string .= '<button type="submit" class="' . $class . ' ms-2">' . $label . '</button>';
                    break;
                case 'form_option':
                case 'form_dropdown':
    ...
    private function _label($link_to_input_id = TRUE)
    {
        ...
        if (isset($this->elm_options['control_label_class']) && !empty($this->elm_options['control_label_class'])) {
            $this->config['default_control_label_class'] .= $this->elm_options['control_label_class'];
        } else {
            $this->config['default_control_label_class'] .= ' col-md-2 col-sm-4';
        }
