...
$(document).ready(function () {
  ...
  $("body").on("click", "#add-variant", function () {
    const tbodyEl = $(".form-table-variants");
    const lastIndex = $(this)
      .parent()
      .find(".form-table-variants")
      .find("tr")
      .last()
      .attr("data-rowIndex");

    const index = parseInt(lastIndex) + 1;
    const newRow = `<tr data-rowIndex="${index}">
        <td>
  ...
  $("body").on("click", ".remove-variant", function () {
    ...
    const rowEl = $(".form-table-variants").find(
      "[data-rowIndex=" + index + "]"
    );
  ...
  $("#with-variant").change(function () {
    if ($(this).is(":checked")) {
      $(".display-price").addClass("d-none");
      $(".variant-form").removeClass("d-none");
    } else {
      $(".display-price").removeClass("d-none");
      $(".variant-form").addClass("d-none");
    }
  });
});
